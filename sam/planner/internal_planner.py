...
from sam.planner.graph_search import GraphSearchExplorer
from sam.planner.ls20_solver import Ls20PlanExecutor
...
class InternalPlanner:
    def __init__(
        ...
        *,
        ...
        self.brancher = GraphSearchExplorer(graph)
        self.ls20_plans = Ls20PlanExecutor()
    ...
    def reset_level(self, frame: FrameDataRaw) -> None:
        ...
        h = frame_hash(frame)
        self.visited_hashes = {h}
        self.brancher.reset_level(h)
        self.ls20_plans.on_level_start(frame.levels_completed)
    ...
    def choose_action(
        ...
        *,
        ...
        cached = self.ls20_plans.pop()
        if cached is not None:
            self.state.phase = PlannerPhase.EXECUTE_LIVE
            info["cached_plan"] = True
            return cached, PlannerPhase.EXECUTE_LIVE, info
